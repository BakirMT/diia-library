...
import { Search, BookUp, BookDown, CheckCircle2, User, Library, Clock, RotateCw, X, Trash2, Printer, Mail, Download, FileText } from "lucide-react"
    ...
    if (fineCharged > 0) {
      try {
        ...
        await addFine({ 
          memberId: selectedMemberId, 
          memberName: selectedMember?.name || 'Unknown', 
          reason: `Overdue check-in: ${recordToReturn.book.title}`, 
          amount: fineCharged, 
          startDate: recordToReturn.dueDate,
