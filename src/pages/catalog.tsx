...
import { fetchBooks, addReservation, updateBook, addBook, addNotification, fetchActivities } from "@/src/lib/db"
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {(role === 'Admin' || role === 'Librarian') && (
          <Button onClick={() => setIsAddModalOpen(true)} className="bg-[var(--color-primary)] hover:bg-teal-600">
